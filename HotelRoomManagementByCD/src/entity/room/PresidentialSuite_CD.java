...
public class PresidentialSuite_CD extends Room_CD {
    ...
    public PresidentialSuite_CD(int roomNumber, RoomState state, int customerMaxNum, int customerCurrentNum, int cost, Date checkInDate, Date checkOutDate, List<Customer_CD> customerCheckedIn) {
