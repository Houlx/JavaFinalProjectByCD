...
public class SingleRoom_CD extends Room_CD {
    ...
    public SingleRoom_CD(int roomNumber, RoomState state, int customerMaxNum, int customerCurrentNum, int cost, Date checkInDate, Date checkOutDate, List<Customer_CD> customerCheckedIn) {
